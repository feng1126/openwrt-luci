...
e=t:taboption("base", DummyValue,"opennewwindow" ,  translate("Lastest version"), 
	translate("<input type=\"button\" class=\"cbi-button cbi-button-apply\" value=\"https://github.com/fatedier/frp/releases\" onclick=\"window.open('https://github.com/fatedier/frp/releases')\" />"))
